...
var (
	...
	maxParallelDNSRequests      = flag.Int("maxParallelDNSRequests", 4, "max parallel DNS requests")
	maxParallelNTPRequests      = flag.Int("maxParallelNTPRequests", 4, "max parallel NTP requests")
